...
const styles = StyleSheet.create({
  ...
  slipNo: { fontSize: 9, fontWeight: 'normal' },
  title: { fontSize: 24, fontWeight: 'normal', letterSpacing: 6, textAlign: 'center', flex: 1 },
  issueBox: { width: 150, alignItems: 'flex-end', fontSize: 9, fontWeight: 'normal' },
  recipientLine: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  recipientText: { fontSize: 14, fontWeight: 'normal' },
  shopText: { fontSize: 11, fontWeight: 'normal' },
  ...
  amountValue: { textAlign: 'center', paddingVertical: 10, fontSize: 24, fontWeight: 'normal' },
  ...
  noteText: { fontSize: 9, fontWeight: 'normal', marginBottom: 2 },
  detailTable: { width: 240, marginTop: 4 },
  detailRow: { flexDirection: 'row', borderBottom: '1 solid #000', minHeight: 18 },
  detailLabel: { width: 70, textAlign: 'right', paddingRight: 6, fontWeight: 'normal', paddingTop: 2 },
  detailValue: { flex: 1, fontWeight: 'normal', paddingTop: 2 },
  ...
  headerText: { color: '#fff', fontSize: 8, fontWeight: 'normal', textAlign: 'center' },
  colMaker: { width: 78 },
  colProduct: { width: 234 },
  colQty: { width: 40 },
  colUnit: { width: 86 },
  colAmount: { width: 118 },
  makerText: { fontSize: 8, fontWeight: 'normal' },
  productText: { fontSize: 8, fontWeight: 'normal' },
  numberText: { fontSize: 8, fontWeight: 'normal', textAlign: 'right' },
  totalSection: {
    marginTop: 0,
    marginLeft: 351,
    width: 204,
...
export function ensureFont() {
  ...
  Font.register({
    ...
    fonts: [
      ...
      { src: `${origin}/fonts/NotoSansJP-Bold.ttf`, fontWeight: 'normal' },
    ],
  });
